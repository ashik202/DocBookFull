  ...
  return (
    ...
    <div className="container px-6 py-8 mx-auto">
        <div className="text-center">
            <a href="/" className="text-3xl font-bold text-black    ">Brand</a>

            <div className="flex flex-wrap justify-center mt-5 -mx-4">
                <a href="/" className="mx-4 text-black  " aria-label="Reddit"> Home </a>
                
                <a href="/" className="mx-4 text-black " aria-label="Reddit"> About </a>
                
                <a href="/" className="mx-4 text-black  " aria-label="Reddit"> Teams </a>

                <a href="/" className="mx-4 text-black " aria-label="Reddit"> Privacy </a>

                <a href="/" className="mx-4 text-black  " aria-label="Reddit"> Cookies </a>
            </div>
