...
const DoctorDashbord = () => {
  ...
  return (
    ...
    <div className="flex flex-row">
        <div className="flex w-64 h-screen px-4 py-8 bg-white border-r dark:bg-gray-900 dark:border-gray-700">
          <div className="flex flex-col justify-between flex-1 mt-6">
            <nav>
              ...
              >
                ...
                <span className="mx-4 font-medium">ADD Freetime</span>
              </a>
              ...
              >
                ...
                <span className="mx-4 font-medium">view Apoinments</span>
              </a>
        ...
        <div className='grid lg:grid-cols-2 container max-auto '>
